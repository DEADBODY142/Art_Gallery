...
if (strlen($_SESSION['agmsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    //}
      ...
      $query = mysqli_query($con, "insert into tblartproduct(Title,Dimension,Orientation,Artist, ArtType,ArtMedium,SellingPricing,Description,Image,Image1,Image2,Image3,Image4,RefNum) value('$title','$dimension','$orientation','$artist','$arttype','$artmed','$sprice','$description','$pic','$pic1','$pic2','$pic3','$pic4','$refno')");
      if ($query) {
...
?>
  ...
  <head>
    ...
    <title>Add Art Product | ArtWorks</title>
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <ol class="breadcrumb">
                ...
                <li><i class="fa fa-file-text-o"></i>Art Product</li>
              ...
              <div class="col-lg-6">
                <section class="panel">
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Selling Price(in Rs.)</label>
                      <div class="col-sm-10">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea class="form-control " id="description" type="text" name="description" rows="7" cols="4" required="true" style="resize: none;"></textarea>
                      </div>
                    </div>
                  </div>
                </section>
